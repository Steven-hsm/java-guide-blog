import{_ as n,p as s,q as a,a1 as e}from"./framework-8fa3e4ce.js";const t={},c=e(`<p>单例模式，属于创建类型的一种常用的软件设计模式。通过单例模式的方法创建的类在当前进程中只有一个实例</p><ul><li>懒汉模式：使用的时候才初始化</li><li>饿汉模式：直接初始化</li></ul><h2 id="静态变量" tabindex="-1"><a class="header-anchor" href="#静态变量" aria-hidden="true">#</a> 静态变量</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * 饿汉模式（静态变量）
 */</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,18),p=[c];function l(i,o){return s(),a("div",null,p)}const d=n(t,[["render",l],["__file","单例模式.html.vue"]]);export{d as default};
